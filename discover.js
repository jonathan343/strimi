...
function flipCardToFront(movie_id,likes,dislikes,reviewCount){
                ...
                <div class="member-card pb-2" >
                    ...
                    <div class="mt-2">
                        <div class="row">
                            <div class="col-4">
                                <div class="mt-3">
                                    <h4 id="likes-${movie_id}">${likes}</h4>
                                    <p class="mb-0 text-muted">Likes</p>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="mt-3">
                                    <h4 id="dislikes-${movie_id}">${dislikes}</h4>
                                    <p class="mb-0 text-muted">Dislikes</p>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="mt-3">
                                    <h4 id="reviewCount-${movie_id}">${reviewCount}</h4>
                                    <p class="mb-0 text-muted">Reviews</p>
                                </div>
                            </div>
                        </div>
